...
## [괄호 짝짓기](https://github.com/ljiwoo59/algorithm_practice/tree/main/brackets)
...
여는 괄호 일시 스택에 추가, 닫는 괄호 일시 스택에 있는 해당 괄호 제거. 만약 괄호 불일치 시, 짝이 맞지 않음

## [계산기](https://github.com/ljiwoo59/algorithm_practice/tree/main/calculator)

계산식을 후위표기식으로 바꿔 계산하기

입력 :
* 길이와 테스트케이스
* 테스트케이스는 0 ~ 9 숫자와 괄호, +, * 가 주어진다

출력 :
* 답

스택을 이용하여 피연산자는 그대로 출력, 연산자는 우선순위에 따라 출력하거나 스택에 넣으면서 후위표기식으로 바꾸고, 스택을 이용하여 피연산자를 스택에 넣으며 연산자를 만나면 출력하여 계산

## [비밀번호](https://github.com/ljiwoo59/algorithm_practice/tree/main/password)
...
같은 번호가 붙어있으면 pop 시키고 인덱스를 0으로 초기화 하며 더이상 존재하지 않을때 까지 루프

## [선반](https://github.com/ljiwoo59/algorithm_practice/tree/main/shelf)
...
사람 키의 합의 모든 경우를 구하기 위해 비트연산자를 사용하여 2의 사람수의 경우만큼 계산
